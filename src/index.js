...
function updatePlayersPosInMap() {
    ...
    let posPlayers = currPlayersPlaces.slice();
...
function successBtn() {
    ...
    document.querySelector(".page.mission .feedback").innerHTML = "כל הכבוד! רואים שאתם שולטים בחומר. התחמקתם בהצלחה מהנחש!";
}
...
function failureBtn() {
    ...
    document.querySelector(".page.mission .feedback").innerHTML = "אוי.. כמעט שהצלחתם... החלקתם על הנחש לידכם ונפלתם אחורה...";
}
